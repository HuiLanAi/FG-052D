...
class TCN_GCN_unit(nn.Module):
	...
	def forward(self, x):
		...
		# total, none_zero = count_sparsity(y)
		# self.gcn_total += total
		# self.gcn_none_zero += none_zero
		return self.relu(x)
	
	def out_sparsity(self):
		f = open("conv1x1_sparsity.txt", "a")
		f.write(str((self.gcn_total - self.gcn_none_zero) / self.gcn_total) + '\n')
		f.close()
...
class Model(nn.Module):
	...
	def forward(self, x):
		...
		# if(self.forwd_cnt == 262):
		# 	self.l1.out_sparsity()
		# 	self.l2.out_sparsity()
		# 	self.l3.out_sparsity()
		# 	self.l4.out_sparsity()
		# 	self.l5.out_sparsity()
		# 	self.l6.out_sparsity()
		# 	self.l7.out_sparsity()
		# 	self.l8.out_sparsity()
		# 	self.l9.out_sparsity()
		# 	self.l10.out_sparsity()
