...
threshold = 0.05
load_pretrain = True
# pretrain_model = "./backup_weight/stdwoC/ntu_cv_agcn_joint_origin-59-70560.pt"
...
class Processor():
    ...
    def train(self, epoch, save_model=False):
        ...
        for batch_idx, (data, label, index) in enumerate(process):
            self.global_step += 1
            # get data
            # data = Variable(data.float().cuda(0), requires_grad=False)
            # label = Variable(label.long().cuda(0), requires_grad=False)
